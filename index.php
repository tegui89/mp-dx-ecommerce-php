                        ...
                        <div class="column small-12 as-search-results-tiles as-search-results-width">
                            <div class="as-producttile large-4 small-6 group-1">
                                <div class="as-producttile-tilehero with-paddlenav with-paddlenav-onhover">
                                    <div class="as-dummy-container as-dummy-img">
                                        <img src="<?php echo $_ENV['DOMAIN']?>/assets/samsung-galaxy-s9-xxl.jpg" class="ir ir item-image as-producttile-image  " alt="" width="445" height="445">
                                    </div>
                                    <div class="images mini-gallery gal1 ">
                                        <ul class="clearfix as-producttile-nojs">
                                            <li class="as-searchtile-nojs">
                                                <img src="<?php echo $_ENV['DOMAIN']?>/assets/samsung-galaxy-s9-xxl.jpg" class="ir relatedlink item-image as-producttile-image" alt="" width="445" height="445" data-scale-params-2="wid=890&amp;hei=890&amp;fmt=jpeg&amp;qlt=95&amp;op_usm=0.5,0.5&amp;.v=1502831144597">
                                            </li>
                                        </ul>
                                        <div class="as-isdesktop with-paddlenav with-paddlenav-onhover">
                                            <div class="clearfix image-list xs-no-js as-util-relatedlink relatedlink" data-relatedlink="2|Beats Studio3 Wireless Over‑Ear Headphones - Shadow Gray|MQUF2">
                                                <div class="as-tilegallery-element as-image-selected">
                                                    <div class=""></div>
                                                    <img src="<?php echo $_ENV['DOMAIN']?>/assets/samsung-galaxy-s9-xxl.jpg" class="ir ir item-image as-producttile-image" alt="" data-desc="Samsung galaxy" style="content:-webkit-image-set(url(<?php echo $_ENV['DOMAIN']?>/assets/samsung-galaxy-s9-xxl.jpg) 1x);">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="as-producttile-info" style="min-height: 168px;">
                                    ...
                                    <form action="/detail.php" method="get">
                                        <input type="hidden" name="img" value="<?php echo $_ENV['DOMAIN']?>/assets/samsung-galaxy-s9-xxl.jpg">
                            ...
                            <div class="as-producttile large-4 small-6 group-1">
                                ...
                                <div class="as-producttile-info" style="min-height: 168px;">
                                    ...
                                    <form action="/detail.php" method="get">
                                        <input type="hidden" name="img" value="<?php echo $_ENV['DOMAIN']?>/assets/l6g6.jpg">
                            ...
                            <div class="as-producttile large-4 small-6 group-1">
                                ...
                                <div class="as-producttile-info" style="min-height: 168px;">
                                    ...
                                    <form action="/detail.php" method="get">
                                        <input type="hidden" name="img" value="<?php echo $_ENV['DOMAIN']?>/assets/u_10168742.jpg">
                            ...
                            <div class="as-producttile large-4 small-6 group-2">
                                ...
                                <div class="as-producttile-info" style="min-height: 168px;">
                                    ...
                                    <form action="/detail.php" method="get">
                                        <input type="hidden" name="img" value="<?php echo $_ENV['DOMAIN']?>/assets/motorola-moto-g5-plus-1.jpg">
                            ...
                            <div class="as-producttile large-4 small-6 group-2">
                                ...
                                <div class="as-producttile-info" style="min-height: 168px;">
                                    ...
                                    <form action="/detail.php" method="get">
                                        <input type="hidden" name="img" value="<?php echo $_ENV['DOMAIN']?>/assets/motorola-moto-g4-3.jpg">
                            ...
                            <div class="as-producttile large-4 small-6 group-2">
                                ...
                                <div class="as-producttile-info" style="min-height: 168px;">
                                    ...
                                    <form action="/detail.php" method="get">
                                        <input type="hidden" name="img" value="<?php echo $_ENV['DOMAIN']?>/assets/003.jpg">
